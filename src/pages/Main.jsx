  ...
  return (
    <section id='main'>
      <div className='content-main'>
        ...
        <h1>We offer CDL on-call driver training for novice drivers in Texas with state-of-the-art equipment and real trucks for practical training.</h1>
        ...
        <div className='cards'>
                  ...
                  dispatch(
                    tabEdit({
                      ...
                      tab: {
                        ...
                        paragraphTwo: '• Accommodations for out-of-town students',
          ...
          <div className='card'>
            <img className='img-static' src={premium} alt='hover-premium-truck' />
            <h4>Premium</h4>
            <div className='rate-background'></div>
            <div className='description'>
                  ...
                  dispatch(
                    tabEdit({
                      ...
                      tab: {
                        ...
                        paragraphThree: '• Additional business training for self-employed operators',
                        className: 'rate-background',
                      },
                    })
                  )
